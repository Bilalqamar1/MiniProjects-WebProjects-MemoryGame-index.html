...
curses.curs_set(0)  # Skjul cursor
height, width = screen.getmaxyx()
win = curses.newwin(height, width, 0, 0)
win.keypad(1)
win.timeout(100)  # Opdatering hvert 100 ms

# Initialiser Snake og mad
snake_x = width // 4
snake_y = height // 2
snake = [
    [snake_y, snake_x],
...
while True:
    ...
    if y in [0, height - 1] or x in [0, width - 1] or snake[0] in snake[1:]:
        curses.endwin()
